...
| `apify-live-demo-qr.png` | QR code (900×900) for https://alderman.ai/apify-live-demo — the page where cards generated live at the meetup are published. A slide asset, not read by anything |

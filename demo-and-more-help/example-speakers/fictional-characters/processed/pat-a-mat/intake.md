...
speaker_name:       "Pat a Mat"
speaker_position:   "duct-tape-leads"
speaker_company:    "a-je-to-workshop"
...
# frontmatter, and §2.
topic_category:     "Rapid Prototyping Gone Wrong"
...
Two men, one shed, no manual. Every fix we tried, why it fell off, and the one that finally held. Spoiler: it involved a hammer.
```

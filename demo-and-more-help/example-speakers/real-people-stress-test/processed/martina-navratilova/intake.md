...
speaker_name:       "Martina Navratilova"
speaker_position:   "serve-and-volley"
speaker_company:    "centre-court"
...
# frontmatter, and §2.
topic_category:     "Relentless Iteration"

# --- 5. talk metadata (card footer, right) -- WRITTEN BY ASSISTANT -----------
level:              "adv."           # all | easy | int. | adv.
duration_minutes:   "30"             # number only - the card renders 10 (mins)
...
Fifty-nine Grand Slam titles from one habit: rewrite the training loop every season. Fitness, focus and the long game.
```

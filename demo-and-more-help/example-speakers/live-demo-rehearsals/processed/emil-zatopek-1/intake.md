...
speaker_name:       "Emil Zátopek"
speaker_position:   "long-distance-runner"
speaker_company:    "czech-locomotive"
...
# frontmatter, and §2.
topic_category:     "Intervals for Growth Loops"
...
duration_minutes:   "20"              # number only — the card renders 10 (mins)
...
Three golds in Helsinki, one marathon I had never run. Pace, intervals and pain, applied to your growth loops.
```

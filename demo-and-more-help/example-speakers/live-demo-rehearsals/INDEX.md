...
Rehearsal runs of the on-stage skill, made on 2026-09-17 while preparing
the live demo at the AI-marketing meetup. Each is the crowd-picks-a-name
flow run end to end — name resolved, portrait found, logo made, copy
written, card rendered — and archived here, out of the live queue, exactly
as it ran.

- `generated-images/` — the finished 1200×1200 PNGs.
- `processed/` — the archived speaker folders (form + assets).

| speaker | folders / files | note |
|---|---|---|

...
# Scaffold a folder with: python scripts/new_speaker.py "Name Surname"
...
speaker_focus:      [360, 330]       # optional: centre of the crop, in pixels of
...
1. **Scaffold**: `python scripts/new_speaker.py "Jana Novakova"` creates
...
2. **Fill**: the frontmatter, the description fence, and drop the two images
   into the folder.
3. **Run**: `python scripts/generate.py` takes every folder in `to-process/`;
   or pass specific folders / intake files. No batch cap.

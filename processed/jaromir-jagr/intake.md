...
speaker_name:       "Jaromir Jagr"
speaker_position:   "winger-forever"
speaker_company:    "rytiri-kladno"
...
# frontmatter, and §2.
topic_category:     "Long-Running Processes"

# --- 5. talk metadata (card footer, right) -- WRITTEN BY ASSISTANT -----------
level:              "easy"           # all | easy | int. | adv.
...
Thirty-plus seasons on one uptime graph. Why the mullet, the squats and the number 68 still ship every single night.
```

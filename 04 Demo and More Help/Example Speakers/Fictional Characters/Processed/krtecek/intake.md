...
speaker_name:       "Krtecek"
speaker_position:   "head-of-underground"
speaker_company:    "molehill-labs"
...
# frontmatter, and §2.
topic_category:     "Digging Through Legacy Systems"

# --- 5. talk metadata (card footer, right) -- WRITTEN BY ASSISTANT -----------
level:              "all"              # all | easy | int. | adv.
duration_minutes:   "15"              # number only — the card renders 10 (mins)
...
```topic-category
Digging Through Legacy Systems
```
...
Everything looks simple up top. A mole's guide to tunnelling through legacy systems without collapsing the garden.
```
